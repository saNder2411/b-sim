(ns app.ui.kits.connect.NRG-16-60-I.toolbar-panel
  (:require [helix.core :refer [defnc $ <>]]
            [refx.alpha :refer [use-sub dispatch]]
            [app.ui.shared.components.toolbar :as toolbar]))


(defnc NRG-16-60-I-toolbar-panel []
  (let [show-toolbar (use-sub [:NRG-16-60-I/show-toolbar])]
    (when show-toolbar
      (<>
