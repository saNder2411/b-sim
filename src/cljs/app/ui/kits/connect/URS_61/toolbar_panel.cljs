(ns app.ui.kits.connect.URS-61.toolbar-panel
  ...
  (let [show-toolbar (use-sub [:URS-61/show-toolbar])
    ...
    (when show-toolbar
      (<>
        ...
        ($ toolbar/title {:x 85 :y 110 :fill "#bcbcbc" :title "URS 61"})
