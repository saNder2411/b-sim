(ns app.ui.shared.boiler-plant.actuators.blowdown.sludge-valve.core
  (:require [helix.core :refer [defnc $]]
            [helix.dom :as d]
            [app.ui.shared.boiler-plant.actuators.blowdown.sludge-valve.highlighting-bg :refer [sludge-valve-highlighting-bg]]))

(defnc sludge-valve []
  (d/g {:transform "translate(729.5, 679)"}
       ($ sludge-valve-highlighting-bg)
