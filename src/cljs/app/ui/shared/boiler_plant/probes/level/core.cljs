(ns app.ui.shared.boiler-plant.probes.level.core
  (:require [helix.core :refer [defnc $ <>]]
            [helix.dom :as d]
            [app.ui.shared.boiler-plant.probes.level.highlighting-bg :refer [probe-level-highlighting]]))

(defnc level-probe [{:keys [x hotspot-id]}]
  (let [left-orientation (or (= hotspot-id "low-level-probe-I") (= hotspot-id "low-level-probe-II"))]
