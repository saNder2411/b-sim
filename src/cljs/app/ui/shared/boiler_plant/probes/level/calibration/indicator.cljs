(ns app.ui.shared.boiler-plant.probes.level.calibration.indicator
  (:require [helix.core :refer [defnc]]
            [helix.dom :as d]
            [cljs.pprint :refer [cl-format]]))

(defnc level-cal-indicator [{:keys [point-by-boiler-level water-level digit-level point-pos opacity fill]}]
