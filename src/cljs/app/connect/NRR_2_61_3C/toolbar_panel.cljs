...
(defnc NRR-2-61-3C-toolbar-panel []
  (let [show-toolbar (use-sub [:NRR-2-61-3C-show-toolbar])
        ...
        full-screen (use-sub [:kit-data-by-keywords [:level :controllers "NRR 2-61 3C" :full-screen]])
        switch-1 (use-sub [:kit-data-by-keywords [:level :controllers "NRR 2-61 3C" :switches 1]])
        switch-2 (use-sub [:kit-data-by-keywords [:level :controllers "NRR 2-61 3C" :switches 2]])
        switch-3 (use-sub [:kit-data-by-keywords [:level :controllers "NRR 2-61 3C" :switches 3]])
        switch-4 (use-sub [:kit-data-by-keywords [:level :controllers "NRR 2-61 3C" :switches 4]])]
    (when show-toolbar
      (<>
