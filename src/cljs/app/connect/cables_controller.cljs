...
(defnc cables-controller []
  (let [level-probe-id (use-sub [:level-probe-id])
        ...
        limiter-high-level-id (use-sub [:limiter-high-level-id])
        limiter-low-level-id (use-sub [:limiter-low-level-id])
    ...
    (d/g {:data-desc "CablesController"}
         (d/g {:data-desc "URW-60"}
              (when has-URW-60
                (<>
                  ...
                  (when (and (= level-controller-id "none") (= cond-controller-id "none") (not= limiter-high-level-id "none"))
                    (d/line {:stroke "#d03880" :stroke-width 4 :x1 480 :y1 74 :x2 1130 :y2 74}))

                  (when (and (= level-controller-id "none") (= cond-controller-id "none") (= limiter-high-level-id "none") (not= limiter-low-level-id "none"))
                    (d/line {:stroke "#d03880" :stroke-width 4 :x1 210 :y1 74 :x2 1130 :y2 74}))

                  (when (and (= level-controller-id "none") (= cond-controller-id "none") (= limiter-high-level-id "none") (= limiter-low-level-id "none"))
                    (<>
         ...
         (d/g {:data-desc "Level"}
              (when (not= level-controller-id "none")
                (<>
                  ...
                  (when (and (= cond-controller-id "none") (not= limiter-high-level-id "none"))
                    (d/line {:stroke "#d03880" :stroke-width 4 :x1 480 :y1 74 :x2 904 :y2 74}))

                  (when (and (= cond-controller-id "none") (= limiter-high-level-id "none") (not= limiter-low-level-id "none"))
                    (d/line {:stroke "#d03880" :stroke-width 4 :x1 210 :y1 74 :x2 904 :y2 74}))

                  (when (and (= cond-controller-id "none") (= limiter-high-level-id "none") (= limiter-low-level-id "none"))
                    (<>
         ...
         (d/g {:data-desc "Cond"}
              (when (not= cond-controller-id "none")
                (<>
                  ...
                  (when (not= limiter-high-level-id "none")
                    (d/line {:stroke "#d03880" :stroke-width 4 :x1 480 :y1 74 :x2 634 :y2 74}))

                  (when (and (= limiter-high-level-id "none") (not= limiter-low-level-id "none"))
                    (d/line {:stroke "#d03880" :stroke-width 4 :x1 210 :y1 74 :x2 634 :y2 74}))

                  (when (and (= limiter-high-level-id "none") (= limiter-low-level-id "none"))
                    (<>
         ...
         (d/g {:data-desc "PumpLimiter"}
              (when (not= limiter-high-level-id "none")
                (<>
                  ...
                  (when (not= limiter-low-level-id "none")
                    (d/line {:stroke "#d03880" :stroke-width 4 :x1 210 :y1 74 :x2 364 :y2 74}))

                  (when (= limiter-low-level-id "none")
                    (<>
         ...
         (d/g {:data-desc "BurnerLimiter"}
              (when (not= limiter-low-level-id "none")
                (<>
                  ...
                  (when (or (not= limiter-high-level-id "none") (not= cond-controller-id "none") (not= level-controller-id "none") has-URW-60)
                    (d/line {:stroke "#d03880" :stroke-width 4 :x1 212 :y1 20 :x2 212 :y2 74}))

                  (when (and (= limiter-high-level-id "none") (= cond-controller-id "none") (= level-controller-id "none") (not has-URW-60))
                    (<>
         ...
         (when (and (= limiter-low-level-id "none") (= limiter-high-level-id "none") (= cond-controller-id "none") (= level-controller-id "none") (not has-URW-60))
