(ns app.shared.control-panel.btn-panel-reset
...
(defnc reset-btn []
  (let [sim (use-sub [:sim])
        ...
        reset-handler (case sim
                        ...
                        reset)]
    (d/g
      ($ button-layer {:dl       "M317.26,188.637h-1.237a50.31,50.31,0,0,1-50.31-50.31V78.861H367.57v59.467A50.31,50.31,0,0,1,317.26,188.637Z"
