(ns app.shared.control-panel.btn-panel-run
...
(defnc run-btn []
  (let [sim (use-sub [:sim])
        ...
        start-stop-handler (case sim
                             ...
                             pause)]
    (d/g
      ($ button-layer {:dl       "M468.234,188.637H467a50.309,50.309,0,0,1-50.31-50.31V78.861H518.544v59.467A50.31,50.31,0,0,1,468.234,188.637Z"
