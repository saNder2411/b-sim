...
(defnc checkbox [{:keys [value on-change]}]
  (d/div {:class "control"}
         (d/svg {:viewBox "0 0 31.43 20.05" :style {:position "relative" :height 20 :margin-left 15 :margin-top 5}}
                (if value
                  (<>
                    (d/path {:fill "#d4d4d3" :d "M15.71,18.7A18.43,18.43,0,0,1,.43,10.59a1,1,0,0,1,0-1.12A18.45,18.45,0,0,1,31,9.47a1,1,0,0,1,0,1.12A18.45,18.45,0,0,1,15.71,18.7ZM2.48,10A16.45,16.45,0,0,0,15.71,16.7,16.47,16.47,0,0,0,29,10,16.45,16.45,0,0,0,2.48,10Z"})
                    (d/path {:fill "#d4d4d3" :d "M15.71,3.76A6.27,6.27,0,1,0,22,10,6.26,6.26,0,0,0,15.71,3.76Zm2.15,5.81a1.72,1.72,0,1,1,1.71-1.71A1.71,1.71,0,0,1,17.86,9.57Z"}))
                  (<>
