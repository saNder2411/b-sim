...
(defnc mode-hud-settings []
  (let [value (use-sub [:kit-data-by-keywords [:burner :mode :value]])
        view (use-sub [:kit-data-by-keywords [:burner :mode :view]])]
...
(defnc status-hud-settings []
  (let [unit (use-sub [:kit-data-by-keywords [:burner :status :unit]])
        view (use-sub [:kit-data-by-keywords [:burner :status :view]])]
...
(defnc power-hud-settings []
  (let [unit (use-sub [:kit-data-by-keywords [:burner :power :unit]])
        view (use-sub [:kit-data-by-keywords [:burner :power :view]])]
...
(defnc fuel-consumption-hud-settings []
  (let [unit (use-sub [:kit-data-by-keywords [:burner :fuel-consumption :unit]])
        view (use-sub [:kit-data-by-keywords [:burner :fuel-consumption :view]])]
...
(defnc status-init-value []
  (let [value (use-sub [:kit-data-by-keywords [:burner :init-sim-output :status :value]])]
...
(defnc pressure-init-value-on []
  (let [converted-value (use-sub [:burner-pressure-converted-value-on])
        unit (use-sub [:kit-data-by-keywords [:burner :pressure :unit]])
...
(defnc power-max-init-value []
  (let [converted-value (use-sub [:burner-power-max-converted-value])
        unit (use-sub [:kit-data-by-keywords [:burner :power :unit]])
...
(defnc fuel-consumption-coeff-init-value []
  (let [converted-value (use-sub [:burner-fuel-consumption-coeff-converted-value])
        unit (use-sub [:kit-data-by-keywords [:burner :fuel-consumption :coeff :unit]])
...
(defnc heat-transfer-init-value []
  (let [value (use-sub [:kit-data-by-keywords [:burner :heat-transfer :value]])
        unit (use-sub [:kit-data-by-keywords [:burner :heat-transfer :unit]])
...
(defnc burner-settings []
  (let [show-settings (use-sub [:kit-data-by-keywords [:burner :settings-view]])]
    (when show-settings
