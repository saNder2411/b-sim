(ns app.shared.boiler-plant.probes.temperature.core
  (:require [helix.core :refer [defnc $ <>]]
            [helix.dom :as d]
            [refx.alpha :refer [use-sub]]
            [app.shared.boiler-plant.probes.temperature.probe-highlighting-bg :refer [probe-highlighting-bg]]
            [app.shared.boiler-plant.probes.temperature.sensor :refer [temperature-sensor]]))

(defnc probe-temperature []
  (let [kit (use-sub [:kit])]
    (<>
      ($ temperature-sensor)
      (when (= kit "connect")
