(ns app.shared.boiler-plant.valves.feedwater-pn.toolbar-panel
...
(defnc valve-feedwater-pneumatic-toolbar-panel []
  (let [show-toolbar-panel (use-sub [:feedwater-valve-pn-show-toolbar-panel])]
    (when show-toolbar-panel
      (<>
        ...
        ($ toolbar/btn-wrapper {:x 1114 :y 54 :on-click #(dispatch [:change-feedwater-valve-pn [[:settings-view] true]])}
