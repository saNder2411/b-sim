...
(reg-event-db :sludge-valve/apply-settings
              (fn [{:keys [kit] :as db} _]
...
(reg-event-db :sludge-valve/restore-defaults-settings
              (fn [{:keys [kit] :as db} _]
