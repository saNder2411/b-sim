...
(defn feed-valve-potentiometer-close! [db-atom v]
...
(defn feed-valve-flow-rate-max! [db-atom max-v]
...
(defn feed-valve-sim-step! [db-atom]
  (swap! db-atom #(-> %
