...
var G__33734 = cljs.core.next(xs);
var G__33735 = cljs.core.next(ys);
xs = G__33734;
ys = G__33735;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__33513 = val;
var G__33514 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__33513,G__33514) : f.call(null,G__33513,G__33514));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__33521 = val__$1;
var G__33522 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__33521,G__33522) : f.call(null,G__33521,G__33522));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__33529 = val__$1;
var G__33530 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__33529,G__33530) : f.call(null,G__33529,G__33530));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__33780 = cljs.core.next(es);
var G__33781 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__33780;
tcoll__$1 = G__33781;
continue;
} else {
...
var G__33789 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__33790 = cljs.core.next(es);
ret = G__33789;
es = G__33790;
continue;
} else {
