...
var make_chain = (function (p1__27446_SHARP_){
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.flatten(p1__27446_SHARP_));
});
...
var temp__5804__auto___27509 = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(refx.interceptor.interceptor_QMARK_,chain));
if(cljs.core.truth_(temp__5804__auto___27509)){
var not_i_27510 = temp__5804__auto___27509;
refx.log.error.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["when registering",id,", expected interceptors, but got:",not_i_27510], 0));
} else {
}
...
var _STAR_handling_STAR__orig_val__27475 = refx.events._STAR_handling_STAR_;
var _STAR_handling_STAR__temp_val__27476 = event_v;
(refx.events._STAR_handling_STAR_ = _STAR_handling_STAR__temp_val__27476);

try{return refx.interceptor.execute(event_v,interceptors);
}finally {(refx.events._STAR_handling_STAR_ = _STAR_handling_STAR__orig_val__27475);
}}
} else {
return null;
}
...
var map__27489 = refx.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$1(context);
var map__27489__$1 = cljs.core.__destructure_map(map__27489);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27489__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27489__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__27499 = refx.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$1(context);
var map__27499__$1 = cljs.core.__destructure_map(map__27499);
var coeffects = map__27499__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27499__$1,new cljs.core.Keyword(null,"event","event",301435442));
