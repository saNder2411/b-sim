...
var make_chain = (function (p1__36854_SHARP_){
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.flatten(p1__36854_SHARP_));
});
...
var temp__5804__auto___36874 = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(refx.interceptor.interceptor_QMARK_,chain));
if(cljs.core.truth_(temp__5804__auto___36874)){
var not_i_36875 = temp__5804__auto___36874;
refx.log.error.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["when registering",id,", expected interceptors, but got:",not_i_36875], 0));
} else {
}
...
var _STAR_handling_STAR__orig_val__36860 = refx.events._STAR_handling_STAR_;
var _STAR_handling_STAR__temp_val__36862 = event_v;
(refx.events._STAR_handling_STAR_ = _STAR_handling_STAR__temp_val__36862);

try{return refx.interceptor.execute(event_v,interceptors);
}finally {(refx.events._STAR_handling_STAR_ = _STAR_handling_STAR__orig_val__36860);
}}
} else {
return null;
}
...
var map__36865 = refx.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$1(context);
var map__36865__$1 = cljs.core.__destructure_map(map__36865);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36865__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36865__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__36867 = refx.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$1(context);
var map__36867__$1 = cljs.core.__destructure_map(map__36867);
var coeffects = map__36867__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36867__$1,new cljs.core.Keyword(null,"event","event",301435442));
