...
refx.alpha.reg_sub(new cljs.core.Keyword(null,"NRR-2-60-calibration","NRR-2-60-calibration",-134434179),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"NRR-2-60","NRR-2-60",1501996277)], null),(function (p__33688,_){
var map__33691 = p__33688;
var map__33691__$1 = cljs.core.__destructure_map(map__33691);
var calibration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33691__$1,new cljs.core.Keyword(null,"calibration","calibration",1895019353));
var map__33695 = calibration;
var map__33695__$1 = cljs.core.__destructure_map(map__33695);
var points = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33695__$1,new cljs.core.Keyword(null,"points","points",-1486596883));
var cal_p = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33695__$1,new cljs.core.Keyword(null,"cal-p","cal-p",-565809412));
...
refx.alpha.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"NRR-2-60-show-toolbar","NRR-2-60-show-toolbar",-1378612021),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"current-hotspot","current-hotspot",965996237)], null),new cljs.core.Keyword(null,"<-","<-",760412998),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"level-controller-id","level-controller-id",-527625219)], null),(function (p__33700,_){
var vec__33706 = p__33700;
var current_hotspot = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33706,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33706,(1),null);
