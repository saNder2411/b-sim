...
return new cljs.core.Keyword(null,"sim","sim",-1444922721).cljs$core$IFn$_invoke$arity$1(db);
}));
refx.alpha.reg_sub.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"lang","lang",-1819677104),(function (db,_){
return new cljs.core.Keyword(null,"lang","lang",-1819677104).cljs$core$IFn$_invoke$arity$1(db);
}));
refx.alpha.reg_sub.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"operation-mode","operation-mode",1063668791),(function (db,_){
return new cljs.core.Keyword(null,"operation-mode","operation-mode",1063668791).cljs$core$IFn$_invoke$arity$1(db);
}));
refx.alpha.reg_sub.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"show-ctrl-panel","show-ctrl-panel",-1185529327),(function (db,_){
return new cljs.core.Keyword(null,"show-ctrl-panel","show-ctrl-panel",-1185529327).cljs$core$IFn$_invoke$arity$1(db);
}));
refx.alpha.reg_sub.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"show-general-settings","show-general-settings",559201945),(function (db,_){
return new cljs.core.Keyword(null,"show-general-settings","show-general-settings",559201945).cljs$core$IFn$_invoke$arity$1(db);
}));
