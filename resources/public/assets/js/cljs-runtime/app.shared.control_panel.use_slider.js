goog.provide('app.shared.control_panel.use_slider');
app.shared.control_panel.use_slider.use_slider = (function app$shared$control_panel$use_slider$use_slider(max_val,next_v__PERCENT_,t_length,knob_r,msg_handler){
...
var vec__32861 = helix.hooks.use_state(init_knob_x);
var knob_x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32861,(0),null);
var set_knob_x_BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32861,(1),null);
var vec__32864 = helix.hooks.use_state(next_v__PERCENT_);
var value__PERCENT_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32864,(0),null);
var set_value__PERCENT__BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32864,(1),null);
var vec__32867 = helix.hooks.use_state(false);
var send_message = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32867,(0),null);
var set_send_message_BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32867,(1),null);
...
var G__32870 = ((next_knob_x / t_length) * (100));
return (set_value__PERCENT__BANG_.cljs$core$IFn$_invoke$arity$1 ? set_value__PERCENT__BANG_.cljs$core$IFn$_invoke$arity$1(G__32870) : set_value__PERCENT__BANG_.call(null,G__32870));
});
...
var G__32871_32874 = helix.hooks.wrap_fx((function (){
if(cljs.core.truth_(send_message)){
var G__32873_32876 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [value__PERCENT_,val_in_unit], null);
(msg_handler.cljs$core$IFn$_invoke$arity$1 ? msg_handler.cljs$core$IFn$_invoke$arity$1(G__32873_32876) : msg_handler.call(null,G__32873_32876));
...
var G__32872_32875 = [value__PERCENT_,val_in_unit,send_message];
(helix.hooks.raw_use_effect.cljs$core$IFn$_invoke$arity$2 ? helix.hooks.raw_use_effect.cljs$core$IFn$_invoke$arity$2(G__32871_32874,G__32872_32875) : helix.hooks.raw_use_effect.call(null,G__32871_32874,G__32872_32875));
...
//# sourceMappingURL=app.shared.control_panel.use_slider.js.map
