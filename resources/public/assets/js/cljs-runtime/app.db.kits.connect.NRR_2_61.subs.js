...
refx.alpha.reg_sub(new cljs.core.Keyword(null,"NRR-2-61-calibration","NRR-2-61-calibration",-1329914427),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"NRR-2-61","NRR-2-61",-2090522858)], null),(function (p__33687,_){
var map__33692 = p__33687;
var map__33692__$1 = cljs.core.__destructure_map(map__33692);
var calibration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33692__$1,new cljs.core.Keyword(null,"calibration","calibration",1895019353));
var map__33697 = calibration;
var map__33697__$1 = cljs.core.__destructure_map(map__33697);
var points = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33697__$1,new cljs.core.Keyword(null,"points","points",-1486596883));
var cal_p = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33697__$1,new cljs.core.Keyword(null,"cal-p","cal-p",-565809412));
...
refx.alpha.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"NRR-2-61-show-toolbar","NRR-2-61-show-toolbar",-1427340718),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"current-hotspot","current-hotspot",965996237)], null),new cljs.core.Keyword(null,"<-","<-",760412998),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"level-controller-id","level-controller-id",-527625219)], null),(function (p__33702,_){
var vec__33712 = p__33702;
var current_hotspot = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33712,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33712,(1),null);
