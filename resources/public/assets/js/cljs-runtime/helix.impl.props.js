...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__35782_SHARP_,p2__35781_SHARP_){
return p2__35781_SHARP_.toUpperCase();
}));
...
var G__35789 = o;
helix.impl.props.goog$module$goog$object.set(G__35789,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__35870 = cljs.core.rest(m);
var G__35871 = (function (){var entry = cljs.core.first(m);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35818_SHARP_){
if(cljs.core.map_QMARK_(p1__35818_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__35818_SHARP_);
} else {
...
while(true){
if(cljs.core.seq(m)){
var G__35892 = cljs.core.rest(m);
var G__35893 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__35915 = cljs.core.rest(m);
var G__35916 = (function (){var entry = cljs.core.first(m);
var k = cljs.core.key(entry);
var v = cljs.core.val(entry);
