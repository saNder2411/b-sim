...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__28054_SHARP_,p2__28053_SHARP_){
return p2__28053_SHARP_.toUpperCase();
}));
...
var G__28055 = o;
helix.impl.props.goog$module$goog$object.set(G__28055,k,v);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28070_SHARP_){
if(cljs.core.map_QMARK_(p1__28070_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__28070_SHARP_);
} else {
...
while(true){
if(cljs.core.seq(m)){
var G__28088 = cljs.core.rest(m);
var G__28089 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__28094 = cljs.core.rest(m);
var G__28095 = (function (){var entry = cljs.core.first(m);
var k = cljs.core.key(entry);
var v = cljs.core.val(entry);
