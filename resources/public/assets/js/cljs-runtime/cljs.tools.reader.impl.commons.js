...
var G__30440 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__30440;
continue;
} else {
return ch;
...
var vec__30396 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30396,(0),null);
return (match === s);
});
...
var i__5770__auto___30475 = (0);
while(true){
if((i__5770__auto___30475 < len__5769__auto___30473)){
args__5775__auto__.push((arguments[i__5770__auto___30475]));

var G__30477 = (i__5770__auto___30475 + (1));
i__5770__auto___30475 = G__30477;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq30415){
...
return (function() { 
var G__30482__delegate = function (rdr,_){
...
var G__30482 = function (rdr,var_args){
var _ = null;
...
return G__30482__delegate.call(this,rdr,_);};
G__30482.cljs$lang$maxFixedArity = 1;
...
return G__30482__delegate(rdr,_);
});
