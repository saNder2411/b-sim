...
var vec__27447_27534 = clojure.data.diff(orig_db,new_db);
var only_before_27535 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27447_27534,(0),null);
var only_after_27536 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27447_27534,(1),null);
var db_changed_QMARK__27537 = (((!((only_before_27535 == null)))) || ((!((only_after_27536 == null)))));
if(db_changed_QMARK__27537){
refx.log.info.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["only before:",only_before_27535], 0));

refx.log.info.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["only after :",only_after_27536], 0));
} else {
...
var vec__27458 = refx.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$2(context,new cljs.core.Keyword(null,"event","event",301435442));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27458,(0),null);
var payload = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27458,(1),null);
var event = vec__27458;
...
var i__5770__auto___27540 = (0);
while(true){
if((i__5770__auto___27540 < len__5769__auto___27539)){
args__5775__auto__.push((arguments[i__5770__auto___27540]));

var G__27541 = (i__5770__auto___27540 + (1));
i__5770__auto___27540 = G__27541;
continue;
} else {
}
break;
...
/** @this {Function} */
(refx.interceptors.path.cljs$lang$applyTo = (function (seq27474){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq27474));
}));
...
var args__5775__auto__ = [];
var len__5769__auto___27546 = arguments.length;
var i__5770__auto___27547 = (0);
while(true){
if((i__5770__auto___27547 < len__5769__auto___27546)){
args__5775__auto__.push((arguments[i__5770__auto___27547]));

var G__27548 = (i__5770__auto___27547 + (1));
i__5770__auto___27547 = G__27548;
continue;
} else {
}
break;
...
var new_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27511_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(new_db,p1__27511_SHARP_);
}),in_paths);
var old_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27512_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(old_db,p1__27512_SHARP_);
}),in_paths);
...
/** @this {Function} */
(refx.interceptors.on_changes.cljs$lang$applyTo = (function (seq27516){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27517,G__27518,seq27516__$2);
}));
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(context,new cljs.core.Keyword(null,"queue","queue",1455835879),(function (p1__27530_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(refx.interceptors.global_interceptors),p1__27530_SHARP_);
}));
})], 0));
