...
var vec__28703 = module$node_modules$react$index.useState(initial);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28703,(0),null);
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28703,(1),null);
var updater = module$node_modules$react$index.useCallback((function() { 
var G__28735__delegate = function (x,xs){
...
var G__28707 = (function helix$hooks$use_state_$_spread_updater(y){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(x,y,xs);
});
return (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(G__28707) : u.call(null,G__28707));
} else {
return (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(x) : u.call(null,x));
}
};
var G__28735 = function (x,var_args){
var xs = null;
...
while (G__28737__i < G__28737__a.length) {G__28737__a[G__28737__i] = arguments[G__28737__i + 1]; ++G__28737__i;}
  xs = new cljs.core.IndexedSeq(G__28737__a,0,null);
} 
return G__28735__delegate.call(this,x,xs);};
G__28735.cljs$lang$maxFixedArity = 1;
G__28735.cljs$lang$applyTo = (function (arglist__28738){
var x = cljs.core.first(arglist__28738);
var xs = cljs.core.rest(arglist__28738);
return G__28735__delegate(x,xs);
});
...
if((ref.current == null)){
(ref.current = (function (){var x28708 = ({"current": x});
(x28708.cljs$core$IDeref$ = cljs.core.PROTOCOL_SENTINEL);

(x28708.cljs$core$IDeref$_deref$arity$1 = (function (this$){
var this$__$1 = this;
return this$__$1.current;
}));

(x28708.cljs$core$IReset$ = cljs.core.PROTOCOL_SENTINEL);

(x28708.cljs$core$IReset$_reset_BANG_$arity$2 = (function (this$,v){
var this$__$1 = this;
return helix.hooks.goog$module$goog$object.set(this$__$1,"current",v);
}));

(x28708.cljs$core$ISwap$ = cljs.core.PROTOCOL_SENTINEL);

(x28708.cljs$core$ISwap$_swap_BANG_$arity$2 = (function (this$,f){
var this$__$1 = this;
return helix.hooks.goog$module$goog$object.set(this$__$1,"current",(function (){var G__28709 = this$__$1.current;
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__28709) : f.call(null,G__28709));
})());
}));

(x28708.cljs$core$ISwap$_swap_BANG_$arity$3 = (function (this$,f,a){
var this$__$1 = this;
return helix.hooks.goog$module$goog$object.set(this$__$1,"current",(function (){var G__28710 = this$__$1.current;
var G__28711 = a;
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__28710,G__28711) : f.call(null,G__28710,G__28711));
})());
}));

(x28708.cljs$core$ISwap$_swap_BANG_$arity$4 = (function (this$,f,a,b){
var this$__$1 = this;
return helix.hooks.goog$module$goog$object.set(this$__$1,"current",(function (){var G__28712 = this$__$1.current;
var G__28713 = a;
var G__28714 = b;
return (f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__28712,G__28713,G__28714) : f.call(null,G__28712,G__28713,G__28714));
})());
}));

(x28708.cljs$core$ISwap$_swap_BANG_$arity$5 = (function (this$,f,a,b,xs){
var this$__$1 = this;
 ...
 */
helix.hooks.use_subscription = (function helix$hooks$use_subscription(p__28728){
var map__28729 = p__28728;
var map__28729__$1 = cljs.core.__destructure_map(map__28729);
var get_current_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28729__$1,new cljs.core.Keyword(null,"get-current-value","get-current-value",-1706578691));
var subscribe = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28729__$1,new cljs.core.Keyword(null,"subscribe","subscribe",416253756));
var vec__28730 = module$node_modules$react$index.useState((function (){
...
var state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28730,(0),null);
var set_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28730,(1),null);
...
return (set_state.cljs$core$IFn$_invoke$arity$1 ? set_state.cljs$core$IFn$_invoke$arity$1(G__28733) : set_state.call(null,G__28733));
} else {
return null;
}
});
...
var value = (get_current_value.cljs$core$IFn$_invoke$arity$0 ? get_current_value.cljs$core$IFn$_invoke$arity$0() : get_current_value.call(null));
var G__28734_28773 = ({"get-current-value": get_current_value, "subscribe": subscribe, "value": value});
(set_state.cljs$core$IFn$_invoke$arity$1 ? set_state.cljs$core$IFn$_invoke$arity$1(G__28734_28773) : set_state.call(null,G__28734_28773));
