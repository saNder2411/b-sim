...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30036 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30036(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_30040 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_30040(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_30043 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_30043(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_30048 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_30048(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30064 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30064(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30071 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30071(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__30011,callback){
var map__30014 = p__30011;
var map__30014__$1 = cljs.core.__destructure_map(map__30014);
var input = map__30014__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30014__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30014__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
