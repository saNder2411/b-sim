goog.provide('app.shared.sidebar.control_panel.slider_hook');
app.shared.sidebar.control_panel.slider_hook.use_slider = (function app$shared$sidebar$control_panel$slider_hook$use_slider(max_val,next_v__PERCENT_,t_length,knob_r,msg_handler){
...
var vec__41600 = helix.hooks.use_state(init_knob_x);
var knob_x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41600,(0),null);
var set_knob_x_BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41600,(1),null);
var vec__41603 = helix.hooks.use_state(next_v__PERCENT_);
var value__PERCENT_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41603,(0),null);
var set_value__PERCENT__BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41603,(1),null);
var vec__41606 = helix.hooks.use_state(false);
var send_message = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41606,(0),null);
var set_send_message_BANG_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41606,(1),null);
...
var G__41683 = ((next_knob_x / t_length) * (100));
return (set_value__PERCENT__BANG_.cljs$core$IFn$_invoke$arity$1 ? set_value__PERCENT__BANG_.cljs$core$IFn$_invoke$arity$1(G__41683) : set_value__PERCENT__BANG_.call(null,G__41683));
});
...
var G__41731_41785 = helix.hooks.wrap_fx((function (){
if(cljs.core.truth_(send_message)){
var G__41737_41790 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [value__PERCENT_,val_in_unit], null);
(msg_handler.cljs$core$IFn$_invoke$arity$1 ? msg_handler.cljs$core$IFn$_invoke$arity$1(G__41737_41790) : msg_handler.call(null,G__41737_41790));
...
var G__41732_41787 = [value__PERCENT_,val_in_unit,send_message];
(helix.hooks.raw_use_effect.cljs$core$IFn$_invoke$arity$2 ? helix.hooks.raw_use_effect.cljs$core$IFn$_invoke$arity$2(G__41731_41785,G__41732_41787) : helix.hooks.raw_use_effect.call(null,G__41731_41785,G__41732_41787));
...
//# sourceMappingURL=app.shared.sidebar.control_panel.slider_hook.js.map
