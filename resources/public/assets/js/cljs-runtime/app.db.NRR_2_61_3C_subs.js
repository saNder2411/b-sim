goog.provide('app.db.NRR_2_61_3C_subs');
...
app.db.NRR_2_61_3C_subs.max_high_point_by_cal_p = (32767);
app.db.NRR_2_61_3C_subs.min_high_point_by_cal_p = 8191.75;
app.db.NRR_2_61_3C_subs.min_level_by_boiler = 78.21877;
app.db.NRR_2_61_3C_subs.max_level_by_boiler = 97.86859;
app.db.NRR_2_61_3C_subs.max_range_by_boiler = 19.64982;
app.db.NRR_2_61_3C_subs._PERCENT__in_digital_unit = 5.996832179E-4;
app.db.NRR_2_61_3C_subs.calc_real_high_point = (function app$db$NRR_2_61_3C_subs$calc_real_high_point(h_point_by_cal_p,cal_p){
var value = ((h_point_by_cal_p / cal_p) * (100));
if((value > app.db.NRR_2_61_3C_subs.max_high_point_by_cal_p)){
return app.db.NRR_2_61_3C_subs.max_high_point_by_cal_p;
} else {
return value;
}
});
...
var map__45075 = new cljs.core.Keyword(null,"calibration","calibration",1895019353).cljs$core$IFn$_invoke$arity$1(NRR_2_61_3C);
var map__45075__$1 = cljs.core.__destructure_map(map__45075);
var calibration = map__45075__$1;
var high_point_by_cal_p = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45075__$1,new cljs.core.Keyword(null,"high-point-by-cal-p","high-point-by-cal-p",-1957616222));
var next_cal_p = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45075__$1,new cljs.core.Keyword(null,"next-cal-p","next-cal-p",1312212854));
var next_real_high_point = app.db.NRR_2_61_3C_subs.calc_real_high_point(high_point_by_cal_p,next_cal_p);
var next_high_point_by_boiler = (app.db.NRR_2_61_3C_subs.min_level_by_boiler + (next_real_high_point * app.db.NRR_2_61_3C_subs._PERCENT__in_digital_unit));
...
refx.alpha.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"NRR-2-61-3C-show-toolbar","NRR-2-61-3C-show-toolbar",-171433172),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"current-hotspot","current-hotspot",965996237)], null),new cljs.core.Keyword(null,"<-","<-",760412998),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"level-controller-id","level-controller-id",-527625219)], null),(function (p__45078,_){
var vec__45083 = p__45078;
var current_hotspot = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45083,(0),null);
var level_controller_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45083,(1),null);
...
//# sourceMappingURL=app.db.NRR_2_61_3C_subs.js.map
