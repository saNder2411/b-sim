...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_29900 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_29900(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_29907 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_29907(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_29912 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_29912(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_29920 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_29920(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_29923 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_29923(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_29929 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_29929(reader);
}
});
...
var G__30075 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__30076 = s.append(c);
c = G__30075;
s = G__30076;
continue;
}
